    ...
    >
      ...
      <div className="md:hidden flex items-center justify-between bg-black text-white px-5 py-3">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="font-semibold">BENNY JOSEPIN</span>
  ...
  return (
    <>
      <div className="p-6 flex flex-col items-center">
        ...
        <h2 className="text-xl font-bold">BENNY JOSEPIN</h2>
        <div className="text-gray-400 text-sm">bennyjosepin6@gmail.com</div>
