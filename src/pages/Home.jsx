        ...
        <div className="max-w-5xl mb-12">
          ...
          <div className="flex flex-col sm:flex-row sm:gap-6 text-gray-400 mb-4 text-left text-sm">
            <div className="flex items-center gap-2 justify-start mb-1 sm:mb-0">
              ...
              sumatra utara, Indonesia <span className="text-sm">🇮🇩</span>
            </div>
          ...
          <div className="max-w-6xl text-gray-300 space-y-4 text-left">
            <p>
              Saya adalah seorang mahasiswa satya terra bhinneka yang sangat
              lucu dan tampan.keahlian saya menjaiili teman, dan hobi saya
              menyanyi dan bermain musik, salah satu musik yang saya senangi
              bermain keybord.dan yang saya pelajari selama kuliah adalah
              belajar ngoding dan ngoding terussss!!!!
            </p>
          </div>
        </div>
